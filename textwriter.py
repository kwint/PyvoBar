    ...
    html = """\
            <html>
              ...
              <body>
                ...
                NIEUW! Wil je altijd inzicht hebben in je saldo, makkelijk kunnen opwaarderen en turfen en nooit meer 
                die vieze turf map aanraken? Meld je aan voor <a href="https://barbapappa.app/b/pivo/join?code=hertogjan">barbapappa!</a> 
                <br>Heb je al een barbappapa account? Dan heb je waarschijnlijk een ander e-mailadres gebruikt dan de 
                gene waarop je deze mail ontvangt. Je kan dit emailadres toevoegen (en verifiëren!) aan je barbapappa acount
                zodat onderstaande turfjes en saldo aan barbappapa worden toegevoegd<br><br>
    ...
    html = """\
            <html>
              ...
              <body>
                ...
                De turfjes van de analoge barlijst zijn weer geupdated! Hier onderaan zie je de turfjes die achter jouw 
                naam stonden. Omdat je een <a href="https://barbapappa.app/b/pivo">barbapappa</a> account hebt worden 
                deze turfjes automatisch verwekt in barbapappa, je kan daar dan ook je 
                <a href="https://barbapappa.app/c/mohicanen/wallets/1/top-up">saldo zien en deze opwaarderen! </a><br><br>
            ...
            """.format(name=data[0], balance=data[9], balance_old=data[2], turf_1=data[3], turf_2=data[4],
                       turf_3=data[5], cost=data[6], pay=data[8], personal_message=personal_message,
